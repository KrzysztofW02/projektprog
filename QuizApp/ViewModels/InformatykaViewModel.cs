...
using static QuizApp.Models.QuizContext;

namespace QuizApp.ViewModels
{
    public class InformatykaViewModel : ViewModelBase
    {
        ...
        {
            using (var context = new Quiz2Context())
            {
                using (var connection = new SQLiteConnection("Data Source=quiz2.db;Version=3;"))
                {
                    connection.Open();

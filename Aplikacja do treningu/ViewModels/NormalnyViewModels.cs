...
{
    public class NormalnyViewModels : INotifyPropertyChanged
    {
        ...
        public Visibility CzasVisibility
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(CzasVisibility)); // aktualizacja widoczności przycisku
            }
        }
        ...
        public Visibility NapisVisibility
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(NapisVisibility)); // aktualizacja widoczności przycisku
            }
        }
        ...
        public NormalnyViewModels() // poczatek@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        {
                ...
                if (time == 0)
                {
                    ...
                    switch (phase)
                    {
                        ...
                        case 7:
                            ...
                            break;
                        default:
                            NapisText = "Something went not yes :>";
                            return;
                    }
